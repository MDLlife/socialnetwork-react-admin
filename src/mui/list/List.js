...
class List extends Component {
    ...
    render() {
        const { filter, resource, hasCreate, title, data, ids, total, children, isLoading,location,quickedit } = this.props;
        ...
        return (
            <Card style={{ margin: '2em', opacity: isLoading ? .8 : 1 }}>
                ...
                <Datagrid quickedit={quickedit} resource={resource} location={location} fields={React.Children.toArray(children)} ids={ids} data={data} currentSort={query} basePath={basePath} updateSort={this.updateSort} />
