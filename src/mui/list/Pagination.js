...
export class Pagination extends Component {
    ...
    nextPage(event) {
        ...
        if (this.props.page > this.getNbPages()) {
            ...
            console.log('WARN: nextPage, Cannot after last page, ',this.props.page,this.getNbPages() );
        }
        this.props.setPage(this.props.page + 1);
    }
    ...
    render() {
        ...
        return (
            <Toolbar>
                ...
                {this.renderPageNums()}
                { total >= perPage - 1 && <FlatButton primary key="next" label="Next" icon={<ChevronRight />} labelPosition="before" onClick={::this.nextPage} style={buttonStyle} /> }
                </ToolbarGroup>
